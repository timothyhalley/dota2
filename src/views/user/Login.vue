  ...
  <div class="main">
    ...
    >
      ...
      >
        <a-tab-pane key="tab1" tab="Account password login">
          <a-form-item>
            <a-input
              ...
              v-decorator="[
                'username',
                {rules: [{ required: true, message: 'Please enter an account name or email address' }, { validator: handleUsernameOrEmail }], validateTrigger: 'change'}
              ]"
            >
          ...
          <a-form-item>
            <a-input
              ...
              type="password"
              autocomplete="false"
              placeholder="Password: admin or member"
              v-decorator="[
                'password',
        ...
        <a-tab-pane key="tab2" tab="Mobile #">
          <a-form-item>
      ...
      <a-form-item>
        <a-checkbox v-decorator="['rememberMe']">Automatic log-in</a-checkbox>
        <router-link
...
export default {
  ...
  methods: {
    ...
    getCaptcha (e) {
      ...
      validateFields(['mobile'], { force: true }, (err, values) => {
        if (!err) {
          ...
          const hide = this.$message.loading('Verification code is being sent..', 0)
    ...
    loginSuccess (res) {
      ...
      // Delay 1 second to display welcome message
      setTimeout(() => {
        this.$notification.success({
          message: 'Welcome',
